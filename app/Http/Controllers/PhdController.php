        ...
        else
        {
            ...
            else if(($checkcandidate != NULL && $checkcandidate->flag == false) || ($reg_candidate != NULL && $reg_candidate->flag == false))
            {
                ...
                $other_details = array(
                    ...
                    'exam' => $details['exam'],
                    'pgproject' => $other_details->input('title_of_project'),
                    'publications1' => $other_details->input('details_of_pub1'),
                    'publications2' => $other_details->input('details_of_pub2'),
                    'publications3' => $other_details->input('details_of_pub3'),
                    'publications4' => $other_details->input('details_of_pub4'),
                    'publications5' => $other_details->input('details_of_pub5'),
                    'publications6' => $other_details->input('details_of_pub6'),
                    'awards1' => $other_details->input('awards1'),
                    'awards2' => $other_details->input('awards2'),
                    'awards3' => $other_details->input('awards3'),
                    'awards4' => $other_details->input('awards4'),
                    'awards5' => $other_details->input('awards5'),
                    'awards6' => $other_details->input('awards6'),
                    );
